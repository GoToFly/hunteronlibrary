...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private static final CharSequence EMPTY_TITLE = "EMPTY_TITLE";
	...
	public class IconPosition {
		...
		public static final int BACKGROUD = 5;
	}

	public Boolean iconInBackgroud = true;
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		if(showBottomLine){
			...
			if (iconResId != 0) {
				...
				case IconPosition.BOTTOM:
					tabView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0,
							iconResId);// ICON在底部
					break;
				case IconPosition.BACKGROUD:
					tabView.setBackgroundResource(iconResId);// ICON当背景
					break;
			...
			final TabView tabView = new TabView(getContext(),showBottomLine);
			tabView.mIndex = index;
			tabView.setFocusable(true);
			tabView.setOnClickListener(mTabClickListener);
			tabView.setText(text);
	...
	private class TabView extends TextView {
		...
		public TabView(Context context,Boolean showBottom) {
			super(context, null, R.attr.vpiTabPageIndicatorHiddenBottomStyle);
		}
